...
<body>
    <form method="post" action="./StudentResultCard.aspx" id="MasterForm">
<div class="aspNetHidden">
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="17682A6D" />
	<input type="hidden" name="__PREVIOUSPAGE" id="__PREVIOUSPAGE" value="K8ryy09kqFuHd1Ksb18E2ENqnRyF55SjFvQ4vZ4UlLaeywM28SVWB2sl0x0DpkXJe239c9ho2V-5AvOVwlMLwnArujBqXTdmVQIfY46TQkU1" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
</div>
...
//]]>
                ...
                <div id="sidebar">
                    <div id="sidebar-wrapper">
                        ...
                        <ul id="main-nav">
                            ...
                            <li><a href="#" id="lnk_Result" class="current nav-top-item">Result</a>
                                <ul>
                                    <li>
                                        <a id="lnk_ResultCard" class="current" href="javascript:__doPostBack(&#39;ctl00$lnk_ResultCard&#39;,&#39;&#39;)">Result 
                                    Card</a>
                                    </li>
                                </ul>
                            </li>
    ...
    <br />
     <div style="overflow: auto; text-align: center; padding-left: 30px;">
        <div id="gradeChart" style="height: 300px; width: 96%;"></div>

    </div>
     <br />  <a id="DataContent_lnkPrint" class="button" href="rptResultCard.aspx" target="_blank">Click Here For Print Version </a>
    <br />
    <br />
    <div id="DataContent_pnlresult" style="width:85%;">
	
    <span><table width='70%' class='Grid' align='center' style='border:1px solid #D8D8D8;font-size:13px;font-weight:bold;'>  <tr><td  colspan='4' style='font-weight:bold;'>Result Semester: Spring 2025</td ></tr></table></span><table align="center" border="1px solid black" cellspacing="1" cellpadding="0" width="600px" class="Grid" style="border:1px solid #D8D8D8;">
		<tr class="tableheader" style="font-weight:bold;">
			<td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Course No</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Course Title</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Credit</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Marks</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">LG</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;"><b>GP</></td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">CSC101          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Applications of Information and Communication Technologies</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">83</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A-  </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3.66</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">CSC103          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Programming Fundamentals</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">90</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A   </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">HUM104          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Functional English</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">83</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A-  </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3.66</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">HUM112          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Islamic Studies</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">2</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">87</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A   </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">HUM122          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Fundamentals of Psychology</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">2</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">95</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A   </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">HUM208          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Civics and Community Engagement</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">2</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">100</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A   </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">MTH091          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Pre-Calculus I</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">Non Credit Course</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">Non Credit Course</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">Non Credit Course</td>
		</tr>
	</table><table align="center">
		<tr border="none" style="font-weight:bold;font-size:11px;font-weight:bold;">
			<td width="15%" style="border:1px solid #D8D8D8;font-weight:bold;padding-top:5px;padding-bottom:5px;">CGPA: 3.87</td><td border="none" style="font-weight:bold;padding-top:5px;padding-bottom:5px;border:1px solid #D8D8D8;">Scholistic Status: GAS  </td>
		</tr>
	</table><span2><br/><br /><br /></span2><span><table width='70%' class='Grid' align='center' style='border:1px solid #D8D8D8;font-size:13px;font-weight:bold;'>  <tr><td  colspan='4' style='font-weight:bold;'>Result Semester: Fall 2025  </td ></tr></table></span><table align="center" border="1px solid black" cellspacing="1" cellpadding="0" width="600px" class="Grid" style="border:1px solid #D8D8D8;">
		<tr class="tableheader" style="font-weight:bold;">
			<td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Course No</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Course Title</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Credit</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Marks</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">LG</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;"><b>GP</></td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">CSC102          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Discrete Structures</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">80</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A-  </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3.66</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">CSC241          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Object Oriented Programming</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">89</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A   </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">HUM113          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Ideology and Constitution of Pakistan</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">2</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">75</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">B+  </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3.33</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">HUM121          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Technical and Business Writing</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">80</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">A-  </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3.66</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">MTH092          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Pre-Calculus II</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">Non Credit Course</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">Non Credit Course</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">Non Credit Course</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">PHY124          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Applied Physics</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">75</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">B+  </td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3.33</td>
		</tr>
	</table><table align="center">
		<tr border="none" style="font-weight:bold;font-size:11px;font-weight:bold;">
			<td width="15%" style="border:1px solid #D8D8D8;font-weight:bold;padding-top:5px;padding-bottom:5px;">CGPA: 3.76</td><td border="none" style="font-weight:bold;padding-top:5px;padding-bottom:5px;border:1px solid #D8D8D8;">Scholistic Status: GAS  </td>
		</tr>
	</table><span2><br/><br /><br /></span2><span><table width='70%' class='Grid' align='center' style='border:1px solid #D8D8D8;font-size:13px;font-weight:bold;'>  <tr><td  colspan='4' style='font-weight:bold;'>Result Semester: Spring 2026</td ></tr></table></span><table align="center" border="1px solid black" cellspacing="1" cellpadding="0" width="600px" class="Grid" style="border:1px solid #D8D8D8;">
		<tr class="tableheader" style="font-weight:bold;">
			<td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Course No</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Course Title</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Credit</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">Marks</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;">LG</td><td class="GridHeader" align="center" style="border:1px solid #D8D8D8;"><b>GP</></td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">CSC211          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Data Structures</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0.0</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">-</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">CSC270          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Database Systems</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">4</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0.0</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">-</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">CSC291          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Software Engineering</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0.0</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">-</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">EEE240          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Fundamentals of Digital Logic Design</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0.0</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">-</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0</td>
		</tr><tr style="font-size:13px;">
			<td width="15%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">MTH104          </td><td width="45%" class="tablecell" style="padding:0 0 0 10px;text-align:left;border:1px solid #D8D8D8;">Calculus and Analytic Geometry</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">3</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0.0</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">-</td><td width="10%" align="center" class="tablecell" style="border:1px solid #D8D8D8;">0</td>
		</tr>
	</table><table align="center">
		<tr border="none" style="font-weight:bold;font-size:11px;font-weight:bold;">
			<td width="15%" style="border:1px solid #D8D8D8;font-weight:bold;padding-top:5px;padding-bottom:5px;">CGPA: 0.00</td><td border="none" style="font-weight:bold;padding-top:5px;padding-bottom:5px;border:1px solid #D8D8D8;">Scholistic Status: --   </td>
		</tr>
	</table><span2><br/><br /><br /></span2>
</div>
 ...
 <span lang="en-us">
            ...
            (function() {
                <script>  var dom = document.getElementById('gradeChart');
                 var myChart = echarts.init(dom, 'dark', 
                { renderer: 'canvas', useDirtyRect: true });
                var app = {};
                var option;
                const posListgradeChart = [
                ...
                position: { options: posListgradeChart.reduce(function (map, pos) { map[pos] = pos; return map; }, {}) },
                ...
                option = { 
                title: {
                    text: 'Grade Distribution', // The main title
                    subtext: 'Total Grades',       // Optional subtitle
...
,
                legend: {show: true, orient: 'horizontal', left: 'center',   top: 40,  data: ['A              ','A-             ','B              ','B+             '] },
                ...
                data: ['A              ','A-             ','B              ','B+             '],axisLabel: { interval: 0, rotate: 45 } } ],
                yAxis: [ { type: 'value'  } ],
                series: [
            {
                name: 'A              ',
