...
<body>
    <form method="post" action="./AddCellEmailInfo.aspx" onsubmit="javascript:return WebForm_OnSubmit();" id="MasterForm">
<div class="aspNetHidden">
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<script src="/ScriptResource.axd?d=Ao97TM-cBoJAEfyM3eVVHUKqSYTz0CgSOdohqPa6P86mKa_XLGUkMxWsHQINcgF7cM0Oa1AxTi_0FOReOTs2oJdbt-2fywUs6r4QpJuIyIVxPcLe4Twgfkp-_fHX3vz7wCXDy5emr8UEY1IaPa-QEyVxEdC3MoBu3_rbQnu09gk1&amp;t=7f7f23e2" type="text/javascript"></script>
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="7E7E19A2" />
	<input type="hidden" name="__PREVIOUSPAGE" id="__PREVIOUSPAGE" value="sT447qHSk13Hwe3Smp113pVHYqi9K8GO-P6l7FBf9JAhqTidIE8F9wvoSMbnzWAlcBPQVh3aPONy7yl3XmUOg-IDFL0w4zyyR6e5oJSKxcA1" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
</div>
...
//]]>
                    ...
                    <div id="sidebar-wrapper">
                        ...
                        <ul id="main-nav">
                            ...
                            <li><a href="#" id="lnk_Settings" class="current nav-top-item">Settings</a>
                                <ul>
                                    <li>
                                        <a id="lnk_Profile" class="current" href="javascript:__doPostBack(&#39;ctl00$lnk_Profile&#39;,&#39;&#39;)">Profile</a>
                                    </li>
                                    <li>
    ...
    <h3>
        Add Student's Cell, Email information</h3>
    ...
    <div id="DataContent_divMessage" class="notification information png_bg">
        ...
        <div>
            Note : Please enter the following details to get full access to CUOnline Student Console.The cell number and email will be used for CUOnline notifications.
        </div>
    </div>
    <table>
        <tr>
        ...
        <tr>
            <td style="width: 20%">
                <span id="DataContent_lblCell">Cell Number:</span>
            </td>
            <td style="width: 50%">
                <input name="ctl00$DataContent$txtServiceNo" type="text" value="0329" maxlength="4" id="DataContent_txtServiceNo" class="text-input small-input" style="width:10%;" />
                <span id="DataContent_RequiredFieldValidator2" style="visibility:hidden;"><span class='input-notification error png_bg'>Required</span></span>
                <span>-</span>
                <input name="ctl00$DataContent$txtCellNo" type="text" value="5832130" maxlength="7" id="DataContent_txtCellNo" class="text-input medium-input" style="width:40%;" />
                  <span id="DataContent_RequiredFieldValidator4" style="visibility:hidden;"><span class='input-notification error png_bg'>Required</span></span>
            </td>
            <td>
                <span id="DataContent_lblExText0">e.g 03XX-XXXXXXX</span>
            </td>
        </tr>
        <tr>
            <td style="width: 20%">
                <span id="DataContent_lblCellDesc">Cell Details:</span>
            </td>
            <td style="width: 50%">
                <select name="ctl00$DataContent$ddlCellNoDetail" id="DataContent_ddlCellNoDetail" class="text-input medium-input">
	<option value="-1">------</option>
	<option selected="selected" value="Personal">Personal</option>
	<option value="Father">Father</option>
	<option value="Mother">Mother</option>
	<option value="Gaudrian">Gaudrian</option>
	...
	<option value="Other">Other</option>
                ...
                <span id="DataContent_RequiredFieldValidator1" style="visibility:hidden;"><span class='input-notification error png_bg'>Required</span></span>
            </td>
            <td>
                <span id="DataContent_lblExText">e.g Personal, Parents cell no</span>
            </td>
        </tr>
        <tr>
            <td style="width: 20%">
                <span id="DataContent_lblEmail">Email:</span>
            </td>
            <td style="width: 50%">
                <input name="ctl00$DataContent$txtEmail" type="text" value="danysahibzada@gmail.com" id="DataContent_txtEmail" class="text-input medium-input" style="width:95%;" />
                <span id="DataContent_RequiredFieldValidator3" style="visibility:hidden;"><span class='input-notification error png_bg'>Required</span></span>
                <span id="DataContent_regexEmailValid" style="visibility:hidden;"><span class='input-notification error png_bg'>Invalid Email</span></span>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            <td colspan="3">
                <input type="submit" name="ctl00$DataContent$btnSave" value="Save" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$DataContent$btnSave&quot;, &quot;&quot;, true, &quot;email&quot;, &quot;&quot;, false, false))" id="DataContent_btnSave" class="button" />&nbsp;&nbsp;&nbsp
                <input type="submit" name="ctl00$DataContent$btnCancel" value="Cancel" onclick="return confirm(&#39;Are you sure you want to cancel? &#39;);" id="DataContent_btnCancel" class="button" />
            </td>
        </tr>
        <tr>
            <td colspan="3">
...
<script type="text/javascript">
//<![CDATA[
var Page_Validators =  new Array(document.getElementById("DataContent_RequiredFieldValidator2"), document.getElementById("DataContent_RequiredFieldValidator4"), document.getElementById("DataContent_RequiredFieldValidator1"), document.getElementById("DataContent_RequiredFieldValidator3"), document.getElementById("DataContent_regexEmailValid"));
//]]>
</script>

<script type="text/javascript">
//<![CDATA[
var DataContent_RequiredFieldValidator2 = document.all ? document.all["DataContent_RequiredFieldValidator2"] : document.getElementById("DataContent_RequiredFieldValidator2");
DataContent_RequiredFieldValidator2.controltovalidate = "DataContent_txtServiceNo";
DataContent_RequiredFieldValidator2.validationGroup = "email";
DataContent_RequiredFieldValidator2.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
DataContent_RequiredFieldValidator2.initialvalue = "";
var DataContent_RequiredFieldValidator4 = document.all ? document.all["DataContent_RequiredFieldValidator4"] : document.getElementById("DataContent_RequiredFieldValidator4");
DataContent_RequiredFieldValidator4.controltovalidate = "DataContent_txtCellNo";
DataContent_RequiredFieldValidator4.validationGroup = "email";
DataContent_RequiredFieldValidator4.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
DataContent_RequiredFieldValidator4.initialvalue = "";
var DataContent_RequiredFieldValidator1 = document.all ? document.all["DataContent_RequiredFieldValidator1"] : document.getElementById("DataContent_RequiredFieldValidator1");
DataContent_RequiredFieldValidator1.controltovalidate = "DataContent_ddlCellNoDetail";
DataContent_RequiredFieldValidator1.validationGroup = "email";
DataContent_RequiredFieldValidator1.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
DataContent_RequiredFieldValidator1.initialvalue = "-1";
var DataContent_RequiredFieldValidator3 = document.all ? document.all["DataContent_RequiredFieldValidator3"] : document.getElementById("DataContent_RequiredFieldValidator3");
DataContent_RequiredFieldValidator3.controltovalidate = "DataContent_txtEmail";
DataContent_RequiredFieldValidator3.errormessage = "Email Missing";
DataContent_RequiredFieldValidator3.validationGroup = "email";
DataContent_RequiredFieldValidator3.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
DataContent_RequiredFieldValidator3.initialvalue = "";
var DataContent_regexEmailValid = document.all ? document.all["DataContent_regexEmailValid"] : document.getElementById("DataContent_regexEmailValid");
DataContent_regexEmailValid.controltovalidate = "DataContent_txtEmail";
DataContent_regexEmailValid.errormessage = "Invalid Email";
DataContent_regexEmailValid.validationGroup = "email";
DataContent_regexEmailValid.evaluationfunction = "RegularExpressionValidatorEvaluateIsValid";
DataContent_regexEmailValid.validationexpression = "\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*";
//]]>
</script>
...
document.getElementById('DataContent_RequiredFieldValidator2').dispose = function() {
    Array.remove(Page_Validators, document.getElementById('DataContent_RequiredFieldValidator2'));
}

document.getElementById('DataContent_RequiredFieldValidator4').dispose = function() {
    Array.remove(Page_Validators, document.getElementById('DataContent_RequiredFieldValidator4'));
}

document.getElementById('DataContent_RequiredFieldValidator1').dispose = function() {
    Array.remove(Page_Validators, document.getElementById('DataContent_RequiredFieldValidator1'));
}

document.getElementById('DataContent_RequiredFieldValidator3').dispose = function() {
    Array.remove(Page_Validators, document.getElementById('DataContent_RequiredFieldValidator3'));
}

document.getElementById('DataContent_regexEmailValid').dispose = function() {
    Array.remove(Page_Validators, document.getElementById('DataContent_regexEmailValid'));
}
//]]>
</script>
</form>
